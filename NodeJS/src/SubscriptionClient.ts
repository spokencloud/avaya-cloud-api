...
export class SubscriptionClient {
  ...
  public async createSubscription(
    createSubscriptionRequest: CreateSubscriptionData
  ): Promise<Subscription> {
    const returnedSubscription = await this.restClient
      .createDataSubscription(
        Object.assign({}, createSubscriptionRequest, {
  ...
  public async deleteSubscription(subscriptionId: string): Promise<number> {
    return await this.restClient.deleteDataSubscription(
      this.subAccountAppId,
      subscriptionId
    )
  }
  ...
  public async getSubscription(subscriptionId: string) {
    return await this.restClient.getDataSubscription(
      this.subAccountAppId,
      subscriptionId
    )
  }
