import { SubscriptionClient, createSubscriptionClient } from "../src/SubscriptionClient";
...
describe("SubscriptionClient.ts", () => {
    ...
    test("createSubscription, updateSubscription, deleteSubscription should return subscription", async () => {
        ...
        let updateSubscriptionRequest:Subscription = {
        ...
        let result = await subscriptionClient.deleteSubscription(subscription.subscriptionId)
